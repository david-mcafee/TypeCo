...
class Game {
  ...
  drawStartScreen(context) {
    ...
    context.fillStyle = "rgba(44, 216, " + randomColor +", 1)";
    context.fillText("TYPE COMMAND", Game.X_DIMENSION / 2, 30);

    context.font = "18px Emulogic";
    context.fillStyle = "WHITE";
    // context.fillText("Welcome! Learn to type faster and have fun doing it!", Game.X_DIMENSION / 2, 50);
    ...
    context.fillStyle = "GREEN";
    context.fillText("DELETE/BACKSPACE: UNSELECT", Game.X_DIMENSION / 3, 160);

    // x, y, width, height
    context.fillStyle = "grey";
    context.fillRect(Game.X_DIMENSION / 2, Game.Y_DIMENSION / 2 ,Game.X_DIMENSION / 20, Game.Y_DIMENSION / 20);

    context.textAlign = "center";
    context.fillStyle = "yellow";
    context.fillText("INSTRUCTIONS", Game.X_Dimension, 280);
    context.fillText("Word “missiles” are falling from the sky - your", Game.X_DIMENSION / 2, 310);
    context.fillText("job is to type them before they hit the ground", Game.X_DIMENSION / 2, 330);
    //
    context.fillText("When you start typing a word, it will be SELECTED.", Game.X_DIMENSION / 2, 340);
    context.fillText("You must finish typing this word before it hits the ground", Game.X_DIMENSION / 2, 350);
    //

    context.fillText("CAREFUL! Once you select a word,", Game.X_DIMENSION / 2, 370);
    context.fillText("any typos will cost you points!", Game.X_DIMENSION / 2, 390);
    //

    context.fillStyle = "blue";
    context.fillText("TIPS:", Game.X_DIMENSION / 2, 430);
    context.fillText("Didn’t select the word you wanted? Hit", Game.X_DIMENSION / 2, 460);
    context.fillText("delete/backspace to deselect it and type the word you want", Game.X_DIMENSION / 2, 460);
    //
    context.fillText("Once you unselect a word, it will continue to", Game.X_DIMENSION / 2, 490);
    context.fillText("fall at it’s original speed (faster than when selected)", Game.X_DIMENSION / 2, 490);
