	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function addMissile(options) {
	      this.missiles.push(new Missile({ position: [(Game.X_DIMENSION - 100) * Math.random() + 50, 0], // zero to always generate at top of the screen
	        game: this,
	        color: "red",
	    ...
	    key: "drawExplosions",
	    value: function drawExplosions(context) {
	    ...
	    key: "drawBullets",
	    value: function drawBullets(context) {
	      // DISPLAY BULLETS
	      if (this.bullets.length > 0) {
	        for (var i = 0; i < this.bullets.length; i++) {
	          var bulletPosition = this.bullets[i];
	    ...
	    key: "setLevel",
	    value: function setLevel(context) {
	    ...
	    key: "drawLevelComplete",
	    value: function drawLevelComplete(context) {
	      this.missiles = [];
	      this.selectedWord = [];
	      this.matchedLetters = [];
	      this.explosions = [];
	    ...
	    key: "drawGameOver",
	    value: function drawGameOver(context) {
	      // this.drawScores(context);
	    ...
	    key: "handleMissiles",
	    value: function handleMissiles(context) {
	    ...
	    key: "drawScores",
	    value: function drawScores(context) {
	      // TOTAL
