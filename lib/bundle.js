	  ...
	  _createClass(Game, [{
	    ...
	    value: function draw(context) {
	      ...
	      if (this.startScreen === true) {
	        ...
	        context.font = "24px Emulogic";
	        context.textAlign = "center";
	        context.textBaseline = "middle";
	        context.fillStyle = "red";
	        context.fillText("PLAY/PAUSE: ENTER", 500, 100);
	        context.fillStyle = "blue";
	        context.fillText("END: ESC", 500, 130);
	      } else {
	        ...
	        if (this.explosions.length > 0) {
	          for (var _i = 0; _i < this.explosions.length; _i++) {
	            ...
	            if (Date.now() > this.explosions[_i].time + 4000) {
	              this.explosions.splice(this.explosions[_i], 1);
	            }
	          }
	        }
	        ...
	        if (this.bullets.length > 0) {
	          for (var _i2 = 0; _i2 < this.bullets.length; _i2++) {
	            var bulletPosition = this.bullets[_i2];
