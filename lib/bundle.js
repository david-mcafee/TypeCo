/******/ (function (modules) {
  ...
  /******/ [
      ...
      var Game = (function () {
        function Game() {
          ...
          this.cities = [
            new City({
              position: [
                Game.X_DIMENSION * (1 / 9),
                Game.Y_DIMENSION * (15 / 18),
              ],
        ...
        _createClass(Game, [
              ...
              this.missiles.push(
                new Missile({
                  ...
                  word: Game.dictionaryWords.words[
                    Math.floor(
                      Math.random() * Game.dictionaryWords.words.length
                    )
                  ],
                  radius: 0,
                  speed: this.speed,
          ...
          },
          {
            ...
            value: function drawGamePlay(context) {
              ...
              for (var _i = 0; _i < this.missiles.length; _i++) {
                if (
                  this.missiles[_i].position[1] + this.missiles[_i].radius >=
                  Game.Y_DIMENSION * (17 / 20)
                ) {
                  var pointsDeducted = this.missiles[_i].word.split("").length;
                  var explosionPosition = this.missiles[_i].position;
                  ...
                  for (var idx2 = 0; idx2 < this.cities.length; idx2++) {
                    ...
                    if (
                      this.missiles[_i].position[0] >=
                        this.cities[idx2].position[0] &&
                      this.missiles[_i].position[0] <=
              ...
              if (this.selectedWord.length > 0) {
                if (
                  this.selectedWord[0].position[1] >=
                  Game.Y_DIMENSION * (17 / 20)
                ) {
                  var _pointsDeducted =
                    this.selectedWord[0].word.split("").length;
                  this.totalPoints -= _pointsDeducted * 200;
                  ...
                  for (var idx2 = 0; idx2 < this.cities.length; idx2++) {
                    ...
                    if (
                      ...
                      this.cities[idx2].decreaseHealth(_pointsDeducted * 20);
          ...
          {
            key: "drawGameWon",
            value: function drawGameWon(context) {
              context.font = "60px Emulogic";
              context.textAlign = "center";
              context.textBaseline = "middle";
              var randomColor = Math.floor(Math.random() * 250);
          ...
          },
          {
            ...
            value: function handleMissiles(context) {
              ...
              var randomNumber = Math.floor(
                Math.random() * this.missileCreationRate
              );
          ...
          {
            key: "playMove",
            value: function playMove(keyEntered, context) {
              // ENTER SCREEN
              if (keyEntered === "enter") {
                if (this.startScreen === true) {
                  ...
                  for (var i = 0; i < this.missiles.length; i++) {
                    if (
                      ...
                      this.missiles.splice(
                        this.missiles.indexOf(this.missiles[i]),
                        1
                      );
                ...
                // A WORD HAS ALREADY BEEN SELECTED
                  ...
                  if (keyEntered !== "backspace") {
                    if (this.selectedWord[0].word.split("").length === 0) {
                      // CREATE EXPLOSION
                      var _explosionPosition = this.selectedWord[0].position;
                      var _explosionTime = Date.now();
                      this.createExplosion(_explosionPosition, _explosionTime);
      ...
      var Missile = (function (_MovingObject) {
        ...
        function Missile() {
          ...
          return _possibleConstructorReturn(
            this,
            (Missile.__proto__ || Object.getPrototypeOf(Missile)).call(
              this,
              options
            )
          );
        ...
        _createClass(Explosion, [
          {
            ...
            value: function draw(context) {
              ...
              var string =
                "rgba(255, 255, 255," + this.opacity.toString() + ")";
    ...
    /***/ function (module, exports) {
      ...
      }; // end of constructor // end of class
        ...
        _createClass(GameView, [
          {
            ...
            value: function bindKeyHandlers() {
              ...
              Object.keys(GameView.MOVES).forEach(function (k) {
                ...
                key(k, function () {
                  _this.game.playMove(k, _this.context);
                });
              });
            },
          },
